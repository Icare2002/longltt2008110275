...
//						NHẬP LOẠI HÀNG
	...
	static void Menu() {
		...
		System.out.println("Nhập 1 : Thêm hàng hóa");
		System.out.println("Nhập 2 : Sửa hàng hóa");
		System.out.println("Nhập 3 : Xóa hàng hóa");
		System.out.println("Nhập 4 : Tìm kiếm hàng hóa");
		System.out.println("Nhập 5 : Sắp xếp hàng hóa");
		System.out.println("Nhập 6 : Xem thống kê");
	...
	static void AddRecord(ArrayList<HangHoa> list) {
		HangHoa new_1 = new HangHoa("thực phẩm","Snack Khoai Tây",6000,100,"15-10-2021");
		list.add(new_1);
		HangHoa new_2 = new HangHoa("thực phẩm","Bò Đóng Hộp",35000,150,"18-10-2021");
		list.add(new_2);
		HangHoa new_3 = new HangHoa("thực phẩm","Cá Ngừ Đóng Hộp",35000,80,"18-10-2021");
		list.add(new_3);
		HangHoa new_4 = new HangHoa("thực phẩm","Cơm Cuộn",25000,200,"19-10-2021");
		list.add(new_4);
		HangHoa new_5 = new HangHoa("thực phẩm","Bánh Mì Kẹp ",15000,150,"20-10-2021");
		list.add(new_5);
		HangHoa new_6 = new HangHoa("thực phẩm","Đào Đóng Hộp",60000,150,"22-10-2021");
		list.add(new_6);
		HangHoa new_7 = new HangHoa("thực phẩm","Xúc Xích ",18000,200,"25-10-2021");
		list.add(new_7);
		HangHoa new_8 = new HangHoa("sành sứ","Bộ Chén ",180000,160,"26-10-2021");
		list.add(new_8);
		HangHoa new_9 = new HangHoa("sành sứ","Bộ Ly Trà",155000,200,"26-10-2021");
		list.add(new_9);
		HangHoa new_10 = new HangHoa("sành sứ","Bình Hoa",255000,100,"27-10-2021");
		list.add(new_10);
		HangHoa new_11 = new HangHoa("sành sứ","Bộ Dĩa",130000,100,"28-10-2021");
		list.add(new_11);
		HangHoa new_12 = new HangHoa("sành sứ","Chảo Sứ",189000,266,"30-10-2021");
		list.add(new_12);
		HangHoa new_13 = new HangHoa("sành sứ","Tuần Lộc Sứ",169000,150,"01-11-2021");
		list.add(new_13);
		HangHoa new_14 = new HangHoa("sành sứ","Bộ Vật Trang Trí",350000,100,"02-11-2021");
		list.add(new_14);
		HangHoa new_15 = new HangHoa("điện máy","Máy Giặt LG",11500000,100,"03-11-2021");
		list.add(new_15);
		HangHoa new_16 = new HangHoa("điện máy","QLED TV",21490000,100,"03-11-2021");
		list.add(new_16);
		HangHoa new_17 = new HangHoa("điện máy","Máy Lạnh AQUA",8490000,150,"04-11-2021");
		list.add(new_17);
		HangHoa new_18 = new HangHoa("điện máy","Tủ Lạnh LG",26150000,100,"05-11-2021");
		list.add(new_18);
		HangHoa new_19 = new HangHoa("điện máy","Nồi Cơm Điện",2490000,200,"06-11-2021");
		list.add(new_19);
		HangHoa new_20 = new HangHoa("điện máy","Bếp Điện",4990000,120,"07-11-2021");
		list.add(new_20);
	}
